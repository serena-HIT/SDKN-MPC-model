...
if __name__ == "__main__":
    #env_names = ["CartPole-v1","MountainCarContinuous-v0","Pendulum-v1"]
    #env_names = ["CartPole-v1"]"DampingPendulum",
    ...
    for j in env_names:
        #for i in range(5):
            ...
            parser.add_argument("--suffix",type=str,default="DKUC_withoutSOC_sizeNN")
