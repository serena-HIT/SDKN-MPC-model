...
def train(env_name,train_steps = 5000,suffix="",augsuffix="",\
    ...
    best_loss = 1000.0
    best_state_dict = {}
    logdir = "results/sizeNN_data/"+suffix+"/KNonlinearRNN_"+env_name+augsuffix+"layer{}_AT{}_mode{}_samples{}".format(layer_depth,activation_mode,obs_mode,Ktrain_samples)
