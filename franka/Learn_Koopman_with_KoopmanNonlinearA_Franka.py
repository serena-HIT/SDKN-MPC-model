...
def train(env_name,train_steps =20000,suffix="",all_loss=0,\
    ...
    logdir = "D:\毕业设计\中期\Python\DeepKoopmanWithControl-main\Data/"+suffix+"/"+subsuffix
    if not os.path.exists( "D:\毕业设计\中期\Python\DeepKoopmanWithControl-main\Data/"+suffix):
        os.makedirs( "D:\毕业设计\中期\Python\DeepKoopmanWithControl-main\Data/"+suffix)
    ...
    for i in range(train_steps):
        ...
        if (i+1) % eval_step ==0:
            ...
            if loss<best_loss:
                ...
                torch.save(Saved_dict,"D:\毕业设计\中期\Python\DeepKoopmanWithControl-main\Data/"+subsuffix+".pth")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--suffix",type=str,default="KoopmanA")
